...
print(create_movie("No Country For Old Men (2005)", "Drama", "Crime").name)
print(create_movie("No Country For Old Men (2005))", "Drama", "Crime").genres)
print(create_movie("No Country For Old Men (2005)", "Drama", "Crime").year)
print(create_movie(" (1933)", "Drama", "Crime"))
print(create_movie("No Country For Old Men (33)", "Drama", "Crime"))